...
const flags = [ "US", "EU", "UK", "AU", "SG", "CN", "CA", "CH", "IL", "JP", "SA", "TH", "TR", "PL", "IT", "ES", "DE", "FR", "GR", "IE"]
...
const FlagComponent = () => {
  ...
  return (
    <div className="bg-[#F5EFCF] w-full  flex flex-col items-center justify-center gap-5 px-5 lg:py-16 py-8">

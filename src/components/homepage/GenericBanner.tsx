...
const GenericBanner = ({leftTitle, rightTitle, image, content}: {leftTitle: string, rightTitle: string, image: string, content: string | React.ReactNode}) => {
  return (
    <div className="mb-28 relative overflow-hidden w-full h-[70vh] lg:h-[75vh]">
      ...
      <div className="px-6 flex flex-col mx-auto  h-full">
        ...
        <div className="w-full h-[50%] flex items-end lg:p-16 pb-16  justify-end">
